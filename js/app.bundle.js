...
function labelForDifficultyScore(score) {
...
function evaluateDifficulty(state, rawSettings = state?.generateSettings) {
...
const LEVEL_INFO_ITEM_META = Object.freeze({
...
function analyzeLevelInfo(rawData, { fileName = "untitled-level.json" } = {}) {
...
function splitRequirementsIntoClusterQueue(requirements, settings, random) {
...
function placeLayerClusters({ state, context, requirements, settings, random, previousLayerIndexes, scoreCell }) {
...
function summarizeSpatialDistribution(context, placedClusters) {
